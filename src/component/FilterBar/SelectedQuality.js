...
// get values in quality key and change them to new array 
const option2 =(Data.map((optionItem) => optionItem.quality)).join().split(',')
    ...
    return (
        <div className="selectedDate">
            <Select className="optionItems" onChange={filterCities}>
                <option className='optionItem' value='' defaultValue="selected">Quality</option>
                {option}
            </Select>
        </div>
    )
